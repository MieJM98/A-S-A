...
(function() {
    ...
    function searchForIndex(index) {
        ...
        if (foundIndex) {
            ...
            getRandomResponses("https://raw.githubusercontent.com/MieJM98/A-S-A/main/REGI/        /lnk.txt", 1, function(response1) {
                fillFormWithRandomResponses(response1, 'textarea#proof_1.form-control.alert-on-type-task');

                getRandomResponses("https://raw.githubusercontent.com/MieJM98/A-S-A/main/REGI/          /stnc.txt", 1, function(response2) {
