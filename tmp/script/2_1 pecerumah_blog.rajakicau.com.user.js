// ==UserScript==
// @name         1:2:1 pecerumah_blog.rajakicau.com
...
(function() {
    ...
    function showConfirmationPopup(callback) {
        const shouldFillForm = confirm('Tandremo, valina asa tam 28 Septembre ito, zaano tsara sode niova ny code');
    ...
    const foundIndex = document.body.textContent.includes("3E7I7ZE");
    ...
    if (foundIndex) {
        ...
        showConfirmationPopup(function(shouldFillForm) {
            if (shouldFillForm) {
                ...
                getRandomResponses("https://raw.githubusercontent.com/MieJM98/A-S-A/main/p.e.c.e.r.u.m.a.h_1.2.1/blog_.raja_kica_u.com.txt", 1, function(response1) {
                ...
                fillFormWithRandomResponses(["CODE73151BR"], 'textarea#vproof');  // Change to "vitat"
