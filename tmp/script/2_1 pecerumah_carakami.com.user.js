// ==UserScript==
// @name         1:2:1 pecerumah_carakami.com
...
(function() {
    ...
    const foundIndex = document.body.textContent.includes("3XHZHf5");
    ...
    if (foundIndex) {
        ...
        showConfirmationPopup(function(shouldFillForm) {
            if (shouldFillForm) {
                ...
                getRandomResponses("https://raw.githubusercontent.com/MieJM98/A-S-A/main/p.e.c.e.r.u.m.a.h_1.2.1/cara_kami._com.txt", 1, function(response1) {
                ...
                fillFormWithRandomResponses(["CODE20758CK"], 'textarea#vproof');  // Change to "vitat"
