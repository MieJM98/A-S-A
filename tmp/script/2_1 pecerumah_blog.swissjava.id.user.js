// ==UserScript==
// @name         1:2:1 pecerumah_blog.swissjava.id
...
(function() {
    ...
    function showConfirmationPopup(callback) {
        const shouldFillForm = confirm('Tandremo, valina asa tam 28 Septembre ito, zaano tsara sode niova ny code, 685 of 920');
    ...
    const foundIndex = document.body.textContent.includes("3Bn4I3b");
    ...
    if (foundIndex) {
        ...
        showConfirmationPopup(function(shouldFillForm) {
            if (shouldFillForm) {
                ...
                getRandomResponses("https://raw.githubusercontent.com/MieJM98/A-S-A/main/p.e.c.e.r.u.m.a.h_1.2.1/blog._swis_sjava_.id.txt", 1, function(response1) {
                ...
                fillFormWithRandomResponses(["CODE82312SJ"], 'textarea#vproof');  // Change to "vitat"
